...
menu(){
    clear
    echo "+--------------------------------------------------------------------------------------------------------------+"
    echo -e "|  Telegram Channel : ${YELLOW}@THEST4R${NC} |  YouTube : ${RED}CHANNEL : @AccountPlaneT${NC}   |  Version : ${GREEN} 1.2 ALPHA ${NC} "
    echo "+--------------------------------------------------------------------------------------------------------------+"
    echo -e "${YELLOW}"
    echo -e "  ------- ${GREEN}${YELLOW} ------- "
    echo "|"
    echo -e "|  1 - Install Nginx + Fake-WebSite Template [HTML]"
    echo "|"
